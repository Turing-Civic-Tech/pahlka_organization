# -*- encoding: utf-8 -*-
# stub: rubycritic 3.3.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<parser>.freeze, ["~> 2.4.0"])
      ...
      s.add_development_dependency(%q<bundler>.freeze, [">= 1.3.0", "~> 1.3"])
      ...
      s.add_development_dependency(%q<byebug>.freeze, [">= 8.0", "~> 9.0"])
    else
      ...
      s.add_dependency(%q<parser>.freeze, ["~> 2.4.0"])
      ...
      s.add_dependency(%q<bundler>.freeze, [">= 1.3.0", "~> 1.3"])
      ...
      s.add_dependency(%q<byebug>.freeze, [">= 8.0", "~> 9.0"])
    end
  else
    s.add_dependency(%q<flay>.freeze, ["~> 2.8"])
    s.add_dependency(%q<flog>.freeze, ["~> 4.4"])
